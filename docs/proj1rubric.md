...
|-----|-----|------|---------|
1|workload is spread over the whole team (one team member is often Xtimes more productive than the others...but nevertheless, here is a track record that everyone is contributing a lot)|3|evidence  in GH|
2| Number of commits|3|https://github.com/shahrk/feature-hunt/graphs/commit-activity|
3| Number of commits: by different people|2|https://github.com/shahrk/feature-hunt/graphs/commit-activity|
4| Issues reports: there are **many**|3|https://github.com/shahrk/feature-hunt/issues|
5|  issues are being  closed|3|evidence in GH|
6| DOI badge: exists |3|in GH Readme|
7|Docs: doco generated , format not ugly|3 |We prepared Readme file which is easily readbale and looks good.|
8|Docs: what: point descriptions of each class/function (in isolation) |3|Refer to this example commit: https://github.com/shahrk/feature-hunt/commit/81690d9ee9c4a0d577e301ee3c0c0cadc9d1473e|
...
20| the files CONTRIBUTING.md lists coding standards and lots of tips on how to extend the system without screwing things up|3|https://github.com/shahrk/feature-hunt/blob/main/CONTRIBUTING.md|
21| issues are discussed before they are closed|3|every issue is dicussed by all, then assigned to one appropriate person for closure|
22| Chat channel: exists|3| Google chat was used for communication |
23| test cases:.a large proportion of the issues related to handling failing cases.|3|in GH|
24| evidence that the whole team is using the same tools: everyone can get to all tools and files|3||
25| evidence that the whole team is using the same tools (e.g. config files in the repo, updated by lots of different people)|3|https://github.com/shahrk/feature-hunt/blob/ed52d3273606ef96869c77584c5c5ebdd455810c/backend/requirements.txt highlights that the same libraries are used by all|
26| evidence that the whole team is using the same tools (e.g. tutor can ask anyone to share screen, they demonstrate the system running on their computer)|3||
27| evidence that the members of the team are working across multiple places in the code base|3| https://github.com/shahrk/feature-hunt/graphs/contributors|
28|short release cycles | 3||
29|Documentation provide a clear, high-level overview of your software|3| https://github.com/shahrk/feature-hunt/blob/main/README.md |
30|Documentation clearly describes the type of user who should use your software|3| Told in the video https://github.com/shahrk/feature-hunt/blob/main/README.md|
31|case studies to show how your software has been used by yourself and others|3|Screenshots in https://github.com/shahrk/feature-hunt/blob/main/README.md|
32|Documentation includes a "quick start" guide that provides a short overview of how to use your software with some basic examples of use.|3|https://github.com/shahrk/feature-hunt/blob/main/README.md|
33|Documentation provides clear, step-by-step instructions on how to deploy and use your software.|3|https://github.com/shahrk/feature-hunt/blob/main/README.md|
